...
const resizer = cva<{
    ...
    [
        ...
        'enabled:focus-visible:before:bg-brand-subtle',
        ...
        variants: {
            ...
            active: {
                true: [
                    ...
                    'enabled:focus-visible:before:bg-brand-subtle-hover',
                ],
                false: '',
            },
        },
    ...
    ],
    {
        ...
        compoundVariants: [
            ...
            { orientation: 'vertical', custom: false, className: ['h-1.5', 'w-8'] },
            {
                active: false,
                custom: false,
                className: ['group-focus-visible:bg-brand', 'group-focus-visible:ring-focused'],
            },
